...
@Component
class CreateBarcodeUserDetailsService(private val jwtService: JwtService) : UserDetailsService {
  override fun loadUserByUsername(token: String): UserDetails = token
